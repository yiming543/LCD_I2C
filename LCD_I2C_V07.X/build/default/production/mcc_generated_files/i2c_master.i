...
# 49 "mcc_generated_files/i2c_master.c"
...
# 57 "mcc_generated_files/i2c_master.h" 2
...
# 50 "mcc_generated_files/i2c_master.c" 2
...
# 51 "mcc_generated_files/i2c_master.c" 2
...
static void I2C_SetCallback(i2c_callbackIndex_t idx, i2c_callback_t cb,
                            void *ptr);
...
i2c_error_t I2C_MasterWrite(void) { return I2C_MasterOperation(0); }
# 262 "mcc_generated_files/i2c_master.c"
void I2C_SetBuffer(void *buffer, size_t bufferSize) {
...
# 293 "mcc_generated_files/i2c_master.c"
static void I2C_SetCallback(i2c_callbackIndex_t idx, i2c_callback_t cb,
                            void *ptr) {
  if (cb) {
...
static i2c_fsm_states_t I2C_DO_TX(void) {
  if (I2C_MasterIsNack()) {
    switch (I2C_Status.callbackTable[I2C_DATA_NACK](
        I2C_Status.callbackPayload[I2C_DATA_NACK])) {
...
static i2c_fsm_states_t I2C_DO_RX(void) {
  *I2C_Status.data_ptr++ = I2C_MasterGetRxData();
  if (--I2C_Status.data_length) {
    ...
    I2C_Status.bufferFree = 1;
    switch (I2C_Status.callbackTable[I2C_DATA_COMPLETE](
...
# 424 "mcc_generated_files/i2c_master.c"
static i2c_fsm_states_t I2C_DO_SEND_RESTART_READ(void) {
...
static i2c_fsm_states_t I2C_DO_ADDRESS_NACK(void) {
  ...
  switch (I2C_Status.callbackTable[I2C_ADDR_NACK](
      I2C_Status.callbackPayload[I2C_ADDR_NACK])) {
  case I2C_RESTART_READ:
  case I2C_RESTART_WRITE:
    return I2C_DO_SEND_RESTART();
  default:
...
i2c_operations_t I2C_CallbackReturnStop(void *funPtr) { return I2C_STOP; }

i2c_operations_t I2C_CallbackReturnReset(void *funPtr) {
  return I2C_RESET_LINK;
}
# 500 "mcc_generated_files/i2c_master.c"
static __attribute__((inline)) _Bool I2C_MasterOpen(void) {
  if (!SSPCON1bits.SSPEN) {
    SSPSTAT = 0x00;
    SSPCON1 = 0x08;
...
static __attribute__((inline)) uint8_t I2C_MasterGetRxData(void) { return SSPBUF; }

static __attribute__((inline)) void I2C_MasterSendTxData(uint8_t data) { SSPBUF = data; }

static __attribute__((inline)) void I2C_MasterEnableRestart(void) { SSPCON2bits.RSEN = 1; }
...
static __attribute__((inline)) void I2C_MasterStartRx(void) { SSPCON2bits.RCEN = 1; }

static __attribute__((inline)) void I2C_MasterStart(void) { SSPCON2bits.SEN = 1; }

static __attribute__((inline)) void I2C_MasterStop(void) { SSPCON2bits.PEN = 1; }

static __attribute__((inline)) _Bool I2C_MasterIsNack(void) { return SSPCON2bits.ACKSTAT; }
...
# 566 "mcc_generated_files/i2c_master.c"
static __attribute__((inline)) void I2C_MasterDisableIrq(void) { PIE1bits.SSPIE = 0; }

static __attribute__((inline)) void I2C_MasterClearIrq(void) { PIR1bits.SSPIF = 0; }

static __attribute__((inline)) void I2C_MasterSetIrq(void) { PIR1bits.SSPIF = 1; }
