...
extern _Bool SET1_TimerState;
extern _Bool SET1_RelayState;
...
_Bool SET1_TimerState = 0;
_Bool SET1_RelayState = 0;
...
void KeepTimerCounter(void) {
  if (OutState == 0 || SetTimer1_ON_cnt == 0) {
...
# 209 "RelayControl.c"
  ...
  if (key[1].fShort) {
    ...
    set_time = 1;
    tempTime_cnt = GetTimerN_Value(set_time);
    EEPROM_WriteWord(0,SetTimer1_ON_cnt);
    EEPROM_WriteWord(2,SetTimer1_OFF_cnt);
    Cur_Y = 1;
    LCD_SetCursor(Cur_X, Cur_Y);
  }
