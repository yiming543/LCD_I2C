...
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "0x05" "," "0x00" "," "0x03" "," "0x00" "," "0x00" "," "0x00" "," "0xff" "," "0xff");

__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "0xff" "," "0xff" "," "0xff" "," "0xff" "," "0xff" "," "0xff" "," "0xff" "," "0xff");

void POWER_ON_EEPROM_READ(void) {
  SetTimer1_ON_cnt = EEPROM_ReadWord(0);
  SetTimer1_OFF_cnt = EEPROM_ReadWord(2);
}
