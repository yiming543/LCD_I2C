# 1 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\eeprom.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\eeprom.c" 2
...
# 4 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\cmake\\LCD_I2C\\default\\..\\..\\../eeprom.h" 2
...
# 2 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\eeprom.c" 2
...
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "0x01" "," "0x00" "," "0x01" "," "0x00" "," "0x01" "," "0x00" "," "0xff" "," "0xff");

__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "0xff" "," "0xff" "," "0xff" "," "0xff" "," "0xff" "," "0xff" "," "0xff" "," "0xff");

void POWER_ON_EEPROM_READ(void) {
  TimeMode = eeprom_read(0);
  SetTimer1_cnt = EEPROM_ReadWord(2);
  SetTimer2_cnt = EEPROM_ReadWord(4);
}
