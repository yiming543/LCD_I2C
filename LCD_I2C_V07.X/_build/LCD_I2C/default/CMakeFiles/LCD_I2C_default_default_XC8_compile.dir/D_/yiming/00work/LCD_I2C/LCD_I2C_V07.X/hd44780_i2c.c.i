# 1 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\hd44780_i2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\hd44780_i2c.c" 2
# 144 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\hd44780_i2c.c"
...
# 145 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\hd44780_i2c.c" 2



void PCF8574_LCD_SendNibble(uint8_t nibble, uint8_t rs) {
    uint8_t data = (uint8_t)(nibble << 4) | 0x08;
    if (rs) data |= 0x01;

    I2C_Write1ByteRegister(0x27, 0x00, data | 0x04);
...
void LCD_Command(uint8_t cmd) {
    ...
    PCF8574_LCD_SendNibble(cmd >> 4, 0);
    PCF8574_LCD_SendNibble(cmd & 0x0F, 0);
    _delay((unsigned long)((2)*(32000000/4000.0)));
}

void LCD_Data(uint8_t data) {

    PCF8574_LCD_SendNibble(data >> 4, 1);
    PCF8574_LCD_SendNibble(data & 0x0F, 1);
    _delay((unsigned long)((2)*(32000000/4000.0)));
}
