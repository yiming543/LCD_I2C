# 1 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\LCD.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\LCD.c" 2
...
# 34 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\cmake\\LCD_I2C\\default\\..\\..\\../LCD.h"
...
# 34 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\cmake\\LCD_I2C\\default\\..\\..\\../LCD.h" 2
...
# 6 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\cmake\\LCD_I2C\\default\\..\\..\\../hd44780_i2c.h" 2
...
# 38 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\cmake\\LCD_I2C\\default\\..\\..\\../LCD.h" 2
...
void DISP_SHOW(void);
# 8 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\LCD.c" 2
...
void DISP_SHOW(void) {
  if (fLCD_updata) {
    ...
    case eNormal:
      LCD_Command(0x01);
      LCD_SetCursor(0, 0);
      DispNormal(TimeMode, 1, SetTimer1_cnt, buf);
      LCD_Print(buf);
    ...
    case eTimeAdjustment:
      LCD_Command(0x01);
      LCD_SetCursor(0, 0);
      DispTimeAdjustment(TimeMode, 1, SetTimer1_cnt, buf);
      LCD_Print(buf);
      LCD_SetCursor(0, 1);
      DispTimeAdjustment(TimeMode, 2, SetTimer2_cnt, buf);
      LCD_Print(buf);
