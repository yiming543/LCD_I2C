# 1 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\Key.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\Key.c" 2
...
# 2 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\Key.c" 2
...
void KEY_Init(void);
void CheckKey(void);
# 3 "D:\\yiming\\00work\\LCD_I2C\\LCD_I2C_V07.X\\Key.c" 2
...
void KEY_ScanAll(void) {
  for (uint8_t ii = 0; ii < 4; ii++) {
    ...
    case KEY_LONG:
      if (k->fKeyIn == 1) {
        k->press_long_time_ms += 10;
        if (k->press_long_time_ms >= 40) {
          k->press_long_time_ms = 0;
          k->fLong_100ms = 1;
        }
      } else {
...
void CheckKey(void){
          if (fT0_fT10ms) {
            ...
            key[0].fKeyIn = (PORTBbits.RB0 == 0);
            key[1].fKeyIn = (PORTBbits.RB1 == 0);
            key[2].fKeyIn = (PORTBbits.RB2 == 0);
            key[3].fKeyIn = (PORTBbits.RB3 == 0);
            KEY_ScanAll();
        }
}
