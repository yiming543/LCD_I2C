...
add_executable(LCD_I2C_default_image_mZZ75Hmf ${LCD_I2C_default_library_list})

set_target_properties(LCD_I2C_default_image_mZZ75Hmf PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${LCD_I2C_default_output_dir})
set_target_properties(LCD_I2C_default_image_mZZ75Hmf PROPERTIES OUTPUT_NAME "default")
set_target_properties(LCD_I2C_default_image_mZZ75Hmf PROPERTIES SUFFIX ".elf")

target_link_libraries(LCD_I2C_default_image_mZZ75Hmf PRIVATE ${LCD_I2C_default_default_XC8_FILE_TYPE_link})


# Add the link options from the rule file.
LCD_I2C_default_link_rule(LCD_I2C_default_image_mZZ75Hmf)
