...
void TimeAdjustment(void) {
  ...
  if (KEY_SELECT_L) {
    ...
    eeprom_write(EEPROM_TIME_MODE, TimeMode);
    EEPROM_WriteWord(EEPROM_SET_TIMER1, SetTimer1_cnt);
    EEPROM_WriteWord(EEPROM_SET_TIMER2, SetTimer2_cnt);
  }
}
